...
path = '../../input_shuili/data'
labels_file_path = os.path.join(path, 'train_label.csv')
...
for k, (train_index, test_index) in enumerate(kf.split(df['image_name'], df['label'])):
    train_img, valid_img = df['image_name'][train_index], df['image_name'][test_index]
    train_labels, valid_labels = df['label'][train_index], df['label'][test_index]

    train_paths = '../input_shuili/data/train_image/' + train_img
    valid_paths = '../input_shuili/data/train_image/' + valid_img
